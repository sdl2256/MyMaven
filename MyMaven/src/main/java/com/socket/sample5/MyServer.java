 ...
 * 运行Server
 * java -Djavax.net.ssl.keyStore=mysocket.jks -Djavax.net.ssl.keyStorePassword=mysocket com.socket.sample5.MyServer
 *
 * 运行Client
 * java -Djavax.net.ssl.trustStore=mysocket.jks  -Djavax.net.ssl.trustStorePassword=mysocket com.socket.sample5.MyClient
 */
